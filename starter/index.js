...
function promptTeamManager() {
    inquirer.prompt([
        ...
        //drawing out answers from user input
        ...
        function promptTeamEngineer() {
            inquirer.prompt([
                ...
                //creating an engineer object containing all the info provided by user input
                const engineer = new Engineer(name, id, email, github);

                //Using push function to add the new "engineer" object to the TeamMembers array alongside "manager"
                teamMembers.push(engineer);

                //calling function to prompt user for Intern's details
                promptIntern();
            });
        }
        ...
        function promptIntern() {
            inquirer.prompt([
                ...
                // add prompt in case user wants to add more team members
        ...
        // Call the function to prompt for adding the first team member
        promptTeamEngineer();
    });
}
